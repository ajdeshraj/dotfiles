# Generated by Powerlevel10k configuration wizard on 2022-08-21 at 13:46 IST.
...
() {
  ...
  ###[ virtualenv: python virtual environment (https://docs.python.org/3/library/venv.html) ]###
  # Python virtual environment color. typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=37 Don't show Python version next to the virtual environment name.
